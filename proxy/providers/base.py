...
class ProviderConfig(BaseModel):
    ...
    api_key: str
    # Full key pool for multi-key rotation; defaults to ``(api_key,)`` so
    # single-key construction (incl. tests) keeps working unchanged.
    api_keys: tuple[str, ...] = ()
    ...
    def _default_key_pool(self) -> ProviderConfig:
